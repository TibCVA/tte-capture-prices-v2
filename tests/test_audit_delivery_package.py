        ...
        json.dumps(
            {
                ...
                "technical_scope_status_by_q": {"Q1": "FAIL"},
                "decision_scope_status_by_q": {"Q1": "FAIL"},
                "ceo_decision": "NO-GO",
...
def test_build_delivery_package_creates_zip_and_manifest(tmp_path: Path, monkeypatch) -> None:
    ...
    assert manifest.get("technical_scope_status_by_q", {}).get("Q1") == "FAIL"
    assert manifest.get("decision_scope_status_by_q", {}).get("Q1") == "FAIL"
